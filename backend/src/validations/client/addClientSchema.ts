...
export const addClientSchema = z.object({
  companyName: z
    ...
    .max(200, "Company name must at most 200 characters"),
  contactPersonName: z
    .string()
    .min(1, "Contact Person name must be at least 1 character")
    .max(200, "Contact Peron name must at most 150 characters"),
  phoneNumber: z
    .string()
