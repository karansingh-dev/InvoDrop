...
const SideBar = () => {
    ...
    return <div className="w-64 bg-white flex flex-col border-r border-slate-200">
        ...
        <nav className="py-4">
            <div className="px-3 ">
                <h2 className="mb-2 text-xs text-slate-500 font-bold uppercase tracking-wider px-4">Main</h2>
                <div className="flex flex-col space-y-1">
                    ...
                    {mainLinks.map(({ key, name, to, icon: Icon }) => (
                        ...
                        <Link
                            key={key}
                            to={to}
                            className={clsx("flex items-center gap-3 rounded-md px-4 py-2 text-sm font-medium  ",
                                pathname === to ? "bg-emerald-50 text-emerald-600" : "hover:bg-slate-100 text-slate-700")
                            }
                        >
            ...
            <div className="mt-6 px-3">
                <h2 className="mb-2 text-xs text-slate-500 font-bold uppercase tracking-wider px-4">Settings</h2>
                <div className="flex flex-col space-y-1">
