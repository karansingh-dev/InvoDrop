...
export default function AddClient() {
  ...
  const onSubmit: SubmitHandler<NewClientDataType> = async (data) => {
    try {
      ...
      toast("Error creating new Client");
    }
  };
  ...
  return (
    <div className=" min-h-screen flex flex-col">
      {/* header section  */}
      <header className="flex items-center justify-between px-6 h-14 bg-[#F7F7F7] sticky top-0">
